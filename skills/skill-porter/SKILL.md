...
### Example: Converting an External Skill

```bash
# Convert a remote Claude skill repository into Antigravity format
python port_skill.py --source "https://github.com/anthropics/skills/tree/main/skills/frontend-design" --dest "~/.gemini/config/skills"
```
